...
<html lang="en">
  ...
  <body>
    ...
    <?php if (isset($_GET['state']) && $_GET['state'] == 'ok') {?>
      ...
      <div class="alert alert-danger" role="alert">لطفا تمام موارد را کامل پر کنید</div>
      <?php }?>
      ...
      <form action="proces.php" method="post" class="form-signin">
        ...
        <input name="username" type="mame" id="inputEmail" class="form-control" placeholder="User name" required autofocus>
