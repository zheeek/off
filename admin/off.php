...
$(document).ready(function(){
  ...
  $("#btn-add").click(function(){
    $(".content-loader").fadeOut('slow', function()
    {
      ...
      $(".content-loader").load('addOff_form.php');
      $("#btn-add").hide();
      $("#btn-view").show();
    });
  });
  ...
  <body>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <button class="btn btn-info" type="button" id="btn-add"> <span class="glyphicon glyphicon-pencil"></span> &nbsp; Add OFF</button>
        <button class="btn btn-info" type="button" id="btn-view"> <span class="glyphicon glyphicon-eye-open"></span> &nbsp; View OFF</button>
        <hr />
        ...
        $admin = $_SESSION['id'];
        $stmt = $db_con->prepare("SELECT * FROM offer where admin=? ORDER BY id DESC");
    ...
    while($row=$stmt->fetch(PDO::FETCH_ASSOC))
    {
      ...
      <td align="center">
      <a id="<?php echo $row['id']; ?>" class="edit-link-off" href="#" title="Edit">
      <img src="edit.png" width="20px" />
            </a></td>
      <td align="center"><a id="<?php echo $row['id']; ?>" class="delete-link-off" href="#" title="Delete">
